...
from transformers4 import TransfoXLConfig, TransfoXLLMHeadModel, load_tf_weights_in_transfo_xl
from transformers4.file_utils import CONFIG_NAME, WEIGHTS_NAME
from transformers4.models.transfo_xl import tokenization_transfo_xl as data_utils
from transformers4.models.transfo_xl.tokenization_transfo_xl import CORPUS_NAME, VOCAB_FILES_NAMES
