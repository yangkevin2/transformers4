...
from transformers4 import FSMTConfig, FSMTForConditionalGeneration
from transformers4.file_utils import WEIGHTS_NAME
from transformers4.models.fsmt.tokenization_fsmt import VOCAB_FILES_NAMES
from transformers4.tokenization_utils_base import TOKENIZER_CONFIG_FILE
