...
import requests
import timm
from transformers4 import DeiTFeatureExtractor, ViTConfig, ViTFeatureExtractor, ViTForImageClassification, ViTModel
from transformers4.utils import logging
from transformers4.utils.imagenet_classes import id2label
